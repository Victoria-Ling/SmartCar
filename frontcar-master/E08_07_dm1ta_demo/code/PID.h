...
extern int Cam_Servo_error_pre_pre,Cam_Servo_Kp,Cam_Servo_Kd,Cam_Servo_Ki;
extern int Cam_Servo_error_pre;
extern int Cam_Servo_error;
extern int error1_show;
...
void right_motor_pid_back(void);//you电机增量式PID
