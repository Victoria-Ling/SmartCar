...
#define BEEP_OFF gpio_set_level(C13,0)//蜂鸣器关
#define Servo_max 802
#define Servo_min 652
#define Servo_mid 727
...
#include "tof.h"
#include "Draw_Line.h"
extern long int speed1,speed2;
extern int16 speed1_show,speed2_show,send_speed;
extern int mode_flag;
extern float distance,route,Distance_Integral;
//===================================================用户自定义文件===================================================
