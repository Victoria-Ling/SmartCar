...
#define ADC_CHANNEL3            ADC1_IN13_C3
#define ADC_CHANNEL4            ADC1_IN12_C2
#define ADC_CHANNEL5            ADC1_IN9_B1
...
//取平均
   ...
   float MAX[NUM]={3425,3430,3415,3410,3410};//实际情况改值，实际采集的最大值
...
void self_read_AD(void)
{
    ...
    ad2=adc_mean_filter_convert(ADC1_IN13_C3, 10);
    ad3=adc_mean_filter_convert(ADC1_IN12_C2, 10);
